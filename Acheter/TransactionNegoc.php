...
if($Stock > 0)
{
			...
			//Remise à zero de l'id negoc et des montants d'encheres
			$bdd = new PDO("mysql:host=localhost;dbname=$dbname;charset=UTF8", $db_login, $db_pass);
			$sql = "UPDATE produit SET ID_Negociation = 0 WHERE ID_Produit like '$ID_Produit1'";
			$bdd->query($sql);
			...
			$bdd = new PDO("mysql:host=localhost;dbname=$dbname;charset=UTF8", $db_login, $db_pass);
			$sql = "UPDATE produit SET ContreOffre = 0 WHERE ID_Produit like '$ID_Produit1'";
			$bdd->query($sql);
