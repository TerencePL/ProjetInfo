  ...
  <header class="page-header header container-fluid">
    ...
    <div class="overlay"></div>
      ...
      <?php //**************************[[A REMPLACER PAR DU TEXTE SI PERSONNE N'EST CONNECTE]]****************************** ?>
          ...
          <h1><font size="10pt"><B>Bienvenue à toi petit acheteur<?php // recupération des infos du compte connecté depuis la BDD via son ID
              $database = "ebayece";
            ...
            ?>
              ...
              <ul>
                <li style="color:white"> <font size="+4"> <?php if(isset($_SESSION['ID'])) {echo "".$row['Prenom'];}?><?php if(isset($_SESSION['ID'])) {echo " ".$row['Nom'];} ?></font> </li> 
